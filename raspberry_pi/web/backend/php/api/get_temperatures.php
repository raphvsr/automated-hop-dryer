...
$data = [
  ['sensor' => 'sensor 1', 'temperature' => rand(1, 50)],
  ['sensor' => 'sensor 2', 'temperature' => rand(1, 50)],
  ['sensor' => 'sensor 3', 'temperature' => rand(1, 50)],
  ['sensor' => 'sensor 4', 'temperature' => rand(1, 50)],
  ['sensor' => 'sensor 5', 'temperature' => rand(1, 50)],
  ['sensor' => 'sensor 6', 'temperature' => rand(1, 50)],
];
