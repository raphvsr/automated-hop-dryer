...
ALTER TABLE
    `drying_stages` ADD CONSTRAINT `drying_stages_campaign_id_foreign` FOREIGN KEY(`campaign_id`) REFERENCES `drying_campaigns`(`id`);
ALTER TABLE
    `alerts` ADD CONSTRAINT `alerts_campaign_id_foreign` FOREIGN KEY(`campaign_id`) REFERENCES `drying_campaigns`(`id`);
ALTER TABLE
    `burner_status` ADD CONSTRAINT `burner_status_campaigns_id_foreign` FOREIGN KEY(`campaigns_id`) REFERENCES `drying_campaigns`(`id`);
ALTER TABLE
